...
var createTable = function (tableName) {
	return Model.Bookshelf.knex.schema.createTable(tableName, function (table) {
		...
		columnKeys.forEach(function (key) {
			...
			} else if (Schema[tableName][key].type === "numeric" && Schema[tableName][key].hasOwnProperty("precision") && Schema[tableName][key].hasOwnProperty("scale")) {
				column = table['decimal'](key, Schema[tableName][key].precision, Schema[tableName][key].scale);
			} else {
